...
public class TextureDrawer {
    ...
    private String mVertexShaderFile = "vertex_fbo_blit_x2.glsl";
    private String mFragmentShaderFile = "fragment_fbo_blit_x2.glsl";
    ...
    public TextureDrawer(Context context, String vertexShaderFile, String fragmentShaderFile, int width, int height) {
        mContext = context;
        mWidth = width;
        mHeight = height;
    ...
    private void initDrawer() {
        ...
        //编译顶点着色程序
        String vertexShaderStr = ShaderUtil.loadAssets(mContext, mVertexShaderFile);
        int vertexShaderId = ShaderUtil.compileVertexShader(vertexShaderStr);
        //编译片段着色程序
        String fragmentShaderStr = ShaderUtil.loadAssets(mContext, mFragmentShaderFile);
