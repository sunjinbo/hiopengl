...
public class LightingSourceActivity extends ActionBarActivity {
    protected GLSurfaceView mGLSurfaceView;
    protected LightingSourceRenderer mGLRenderer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGLRenderer = new LightingSourceRenderer(this);
    ...
    private class LightingSourceRenderer implements GLSurfaceView.Renderer, Runnable {
        ...
        public LightingSourceRenderer(Context context) {
            mContext = context;
