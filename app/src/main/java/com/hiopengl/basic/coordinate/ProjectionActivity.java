...
public class ProjectionActivity extends ActionBarActivity {
    protected GLSurfaceView mGLSurfaceView;
    protected ProjectionRenderer mGLRenderer;
    ...
    protected class ProjectionRenderer implements GLSurfaceView.Renderer, Runnable {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            Matrix.frustumM(mProjectMatrix,0,
                    -mRatio * mScale, mRatio * mScale,-1f * mScale,1f * mScale,
                    1f,333f);
