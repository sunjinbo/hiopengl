...
public class ViewModelActivity extends ActionBarActivity {
    ...
    protected ViewModelRenderer mGLRenderer;
    ...
    protected class ViewModelRenderer implements GLSurfaceView.Renderer, Runnable {
        ...
        public ViewModelRenderer(Context context) {
            mContext = context;
