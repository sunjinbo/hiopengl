...
public class BlendingActivity extends ActionBarActivity {
    ...
    private class GLSLRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //编译顶点着色程序
            String vertexShaderStr1 = ShaderUtil.loadAssets(mContext, "vertex_blending_shader_1.glsl");
            int vertexShaderId1 = ShaderUtil.compileVertexShader(vertexShaderStr1);
            //编译片段着色程序
            String fragmentShaderStr1 = ShaderUtil.loadAssets(mContext, "fragment_blending_shader_1.glsl");
            ...
            //编译顶点着色程序
            String vertexShaderStr2 = ShaderUtil.loadAssets(mContext, "vertex_blending_shader_2.glsl");
            int vertexShaderId2 = ShaderUtil.compileVertexShader(vertexShaderStr2);
            //编译片段着色程序
            String fragmentShaderStr2 = ShaderUtil.loadAssets(mContext, "fragment_blending_shader_2.glsl");
