...
public class StencilTestActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stencil_test);
    ...
    private class GLSLRenderer implements GLSurfaceView.Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            GLES30.glStencilOp(GLES30.GL_REPLACE, GLES30.GL_ZERO, GLES30.GL_REPLACE);
